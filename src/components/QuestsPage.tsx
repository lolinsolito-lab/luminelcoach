    ...
    return (
        <div className="max-w-6xl mx-auto pb-20">
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
                <p className="text-[9px] tracking-[0.24em] uppercase mb-2 opacity-70" style={{ color: "#C9A84C" }}>Metodo Michael Luminels · Percorsi di trasformazione</p>
